...
export const radioButtonsGroup = [
  {
    name: 'radio_button', label: 'Radio button 1', radioValue: '1', defaultChecked: true,
  }, {
    ...
    name: 'radio_disabled_button', label: 'Disabled & checked', radioValue: '2', defaultChecked: true, disabled: true,
  },
];
